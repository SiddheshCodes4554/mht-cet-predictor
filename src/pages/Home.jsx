...
export default function Home() {
  ...
  return (
    <div className="home-wrapper">
      ...
      <footer>
        <div className="container">
          <p>&copy; {new Date().getFullYear()} MHT CET College Predictor. Built with ❤️ <a style={{ color: "white" }} href="https://www.linkedin.com/in/siddhesh-gawade-b77535369/">Siddhesh Arun Gawade.</a></p>
        </div>
      </footer>
    </div>
  );
